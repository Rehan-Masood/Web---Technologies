...
<?php endif; ?>
                ...
                <div class="flex items-center justify-between text-slate-300">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a href="<?php echo e(route('password.request')); ?>" class="text-cyan-300 hover:underline">
                            Forgot password?
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <p class="text-center text-slate-400">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="text-cyan-300 font-bold">Register</a>
                </p>
            </form>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH D:\XAMP\htdocs\todo-premium\resources\views/auth/login.blade.php ENDPATH**/ ?>