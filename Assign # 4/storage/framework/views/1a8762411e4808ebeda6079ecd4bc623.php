...
<section class="min-h-screen bg-gradient-to-br from-[#07111f] via-[#111827] to-[#2d1746] px-6 py-8">
    <nav class="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div class="flex gap-4">
            <a href="<?php echo e(route('login')); ?>" class="px-6 py-3 rounded-xl border border-white/10 hover:bg-white/10">Login</a>
            <a href="<?php echo e(route('register')); ?>" class="px-6 py-3 rounded-xl bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-400 font-bold">Get Started</a>
        </div>
    </nav>
    ...
    <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-14 items-center pt-24">
        <div>
            ...
            <div class="flex flex-wrap gap-4 mt-10">
                <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 rounded-2xl bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-400 font-bold text-lg shadow-lg">
                    Create Free Account
                </a>
                <a href="<?php echo e(route('login')); ?>" class="px-8 py-4 rounded-2xl bg-white/10 border border-white/10 font-bold text-lg">
                    Login Now
                </a>
            </div>
...
</html><?php /**PATH D:\XAMP\htdocs\todo-premium\resources\views/welcome.blade.php ENDPATH**/ ?>