        ...
        <div class="w-full max-w-md p-8 rounded-[2rem] bg-white/10 border border-white/10 backdrop-blur-xl shadow-2xl">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-5">
                ...
                <div>
                    ...
                    <input name="name" type="text" value="<?php echo e(old('name')); ?>" required minlength="3" maxlength="50"
                        pattern="[A-Za-z\s]+"
...
<?php endif; ?>
                ...
                <p class="text-center text-slate-400">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="text-cyan-300 font-bold">Login</a>
                </p>
            </form>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH D:\XAMP\htdocs\todo-premium\resources\views/auth/register.blade.php ENDPATH**/ ?>