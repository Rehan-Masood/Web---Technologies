...
<div class="app">
    ...
    <aside class="sidebar">
        ...
        <div class="nav">
            <a href="<?php echo e(route('users.index')); ?>" class="active">🏠 Dashboard</a>
    ...
    <main class="main">
        <div class="topbar">
            ...
            <form class="top-search" method="GET" action="<?php echo e(route('users.index')); ?>">
                <input type="text" name="email" value="<?php echo e($search); ?>" placeholder="Search users, emails...">
            </form>
        </div>
        ...
        <section class="cards">
            ...
            <div class="stat-card">
                <h2><?php echo e($activeUsers); ?></h2>
                <p>Active Users</p>
                <span>↑ 8.4% vs last month</span>
            </div>

            <div class="stat-card">
                <h2><?php echo e($newRegistrations); ?></h2>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($user->profile_picture): ?>
                                        <img class="avatar" src="<?php echo e(asset('uploads/' . $user->profile_picture)); ?>" alt="Photo">
                                    <?php else: ?>
                                        <div class="placeholder-avatar"><?php echo e(strtoupper(substr($user->name, 0, 1))); ?></div>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <a href="<?php echo e(route('users.edit', $user->id)); ?>" class="btn btn-edit">Edit</a>
            ...
            <div>
                <div class="panel" id="search">
                    ...
                    <form method="GET" action="<?php echo e(route('users.index')); ?>">
                        <input type="text" name="email" value="<?php echo e($search); ?>" placeholder="Search by email address...">
                        <button type="submit" class="btn btn-primary" style="width:100%; margin-top:12px;">Search</button>
                        <a href="<?php echo e(route('users.index')); ?>" class="btn btn-reset">Reset Filters</a>
                    </form>

                    <div class="search-result">
                        Showing <?php echo e($users->count()); ?> result(s)
                    </div>
                </div>
...
</html><?php /**PATH D:\XAMP\htdocs\user-management-system\resources\views/users/index.blade.php ENDPATH**/ ?>